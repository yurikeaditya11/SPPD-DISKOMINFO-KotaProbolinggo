                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                ...
                                <?php ;} ?>
                                <form role="form" enctype="multipart/form-data" method="post" action="<?php echo site_url('jalan/actionadd');?>">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Nomor Surat Tugas</label>
                                            <input type="text" name="nomor_surat" class="form-control" placeholder="Enter Nomor Surat Tugas">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <input type="text" name="tanggal_berangkat" id="tanggal_berangkat" class="form-control">
                                        </div>
                                        <div class="form-group">
                                          <label class="control-label">Tanggal Pulang</label>
                                          <input type="text" name="tanggal_pulang" id="tanggal_pulang" class="form-control">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nomor_ticket" class="form-control" placeholder="Enter Nomor Ticket">
                                        </div>
                                        <div class="form-group">
                                          <label for="exampleInputEmail1">Harga Ticket</label>
                                          <input type="text" name="biaya_akomodasi" id="harga_ticket" class="form-control" placeholder="Enter Harga Ticket">
                                        </div>
                                        <div class="form-group">
                                          <label for="exampleInputEmail1">Nama Penginapan</label>
                                          <input type="text" name="nama_hotel" class="form-control" placeholder="Enter Nama Penginapan">
                                        </div>
                                        <div class="form-group">
                                          <label for="exampleInputEmail1">Nomor Kamar</label>
                                          <input type="text" name="nomor_kamar" class="form-control" placeholder="Enter Nomor Kamar">
                                        </div>
                                        <div class="form-group">
                                          <label for="exampleInputEmail1">Harga Penginapan</label>
                                          <input type="text" name="harga_permalam" id="harga_permalam" class="form-control" placeholder="Enter Harga Penginapan Per Malam">
                                        </div>
                                        <div class="form-group">
                                          <label for="exampleInputEmail1">Total</label>
                                          <input type="text" name="total" id="total" class="form-control" placeholder="Enter Total Pembiayaan">
                                        </div>
                                    </div><!-- /.box-body -->
